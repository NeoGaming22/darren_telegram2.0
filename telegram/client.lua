...
function GetFirstname()
    AddTextEntry("FMMC_MPM_TYP8", "Recipient's Firstname: ")
...
function GetLastname(firstname)
    AddTextEntry("FMMC_MPM_TYP8", "Recipient's Lastname: ")
    DisplayOnscreenKeyboard(1, "FMMC_MPM_TYP8", "", "", "", "", "", 30)
...
function GetMessage(firstname, lastname)
    AddTextEntry("FMMC_MPM_TYP8", "Message: ")
    DisplayOnscreenKeyboard(1, "FMMC_MPM_TYP8", "", "", "", "", "", 150)
